...
class MovieOrSeriesRepositoryTest {
    ...
    void itShouldCheckThatTheMoviesAreSortedInAscOrder() {
        ...
        List<MovieOrSeries> expectedList = movieOrSeriesRepository.findAllByOrderByCreationDateAsc();
    ...
    void itShouldCheckThatTheMoviesAreSortedInDscOrder() {
        ...
        List<MovieOrSeries> expectedList = movieOrSeriesRepository.findAllByOrderByCreationDateDesc();
